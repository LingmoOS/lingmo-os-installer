...
{
    if(flagstr == "oem1") {
        LMInstaller::Ksetting::init(":/data/file/ksettingsoem1.conf");
    } else if(flagstr == "oem2") {
        qDebug() << "oem2";
        LMInstaller::Ksetting::init(":/data/file/ksettingsoem2.conf");
    } else {
        LMInstaller::Ksetting::init(":/data/file/ksettings.conf");
    }
}
...
//    LMInstaller::Ksetting::init(":/data/file/ksettings.conf");
    ...
    //("sudo", {"-u", "lingmo", "gsettings", "set" ,"org.lingmoui.flash-disk.autoload" ,"ifautoload", "false"});
    //root  ->  lingmo
    ...
    if(argc > 1) {
        ...
        KServer::KCommand::initCmd()->getInstance()->RunScripCommand("sudo", {"-u", "lingmo", "gsettings", "set" ,"org.lingmoui.flash-disk.autoload" ,"ifautoload", "false"});
