...
//    layout->addItem(new QSpacerItem(10, 36, QSizePolicy::Fixed, QSizePolicy::Fixed), 2, 0, 1, 1);
    ...
    m_loadpic->setPixmap(QPixmap(":/data/svg/loading/lingmoui-loading-0.svg").scaled(QSize(48, 48), Qt::KeepAspectRatio, Qt::SmoothTransformation));
...
void InstallingOEMConfigFrame::finishLoadDisk()
{
    ...
    QString s = QString(":/data/svg/loading/lingmoui-loading-%1.svg").arg(var);
