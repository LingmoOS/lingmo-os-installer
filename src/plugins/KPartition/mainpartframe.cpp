...
void MainPartFrame::initUI()
{
    ...
    m_loadpic->setPixmap(QPixmap(":/res/pic/loading/lingmoui-loading-0.svg").scaled(QSize(48, 48), Qt::KeepAspectRatio, Qt::SmoothTransformation));
...
void MainPartFrame::finishLoadDisk()
{
    ...
    QString s = QString(":/res/pic/loading/lingmoui-loading-%1.svg").arg(var);
