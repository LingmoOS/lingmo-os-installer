...
void ModifyPartitionFrame::setModifyPartition( Partition::Ptr partition)
{
...
void ModifyPartitionFrame::initBackground()
{
    ...
    QPixmap pixmap = QPixmap(":/data/png/bg.jpg").scaled(rect.width(), rect.height(), Qt::KeepAspectRatioByExpanding);
